...
from PySide6.QtWidgets import (QAbstractSpinBox, QApplication, QComboBox, QFrame,
    ...
    QLayout, QRadioButton, QScrollArea, QSizePolicy,
...
class Ui_ExportTab(object):
    def setupUi(self, ExportTab):
        ...
        self.scrollArea_PT = QScrollArea(ExportTab)
        self.scrollArea_PT.setObjectName(u"scrollArea_PT")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scrollArea_PT.sizePolicy().hasHeightForWidth())
        self.scrollArea_PT.setSizePolicy(sizePolicy)
        self.scrollArea_PT.setMinimumSize(QSize(0, 0))
        self.scrollArea_PT.setMaximumSize(QSize(16777215, 16777215))
        self.scrollArea_PT.setStyleSheet(u" QScrollArea {\n"
...
"    }\n"
"")
        self.scrollArea_PT.setWidgetResizable(True)
        self.scrollAreaWidgetContents_PT = QWidget()
        self.scrollAreaWidgetContents_PT.setObjectName(u"scrollAreaWidgetContents_PT")
        self.scrollAreaWidgetContents_PT.setGeometry(QRect(0, 0, 480, 607))
        sizePolicy1 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.scrollAreaWidgetContents_PT.sizePolicy().hasHeightForWidth())
        self.scrollAreaWidgetContents_PT.setSizePolicy(sizePolicy1)
        self.scrollAreaWidgetContents_PT.setMinimumSize(QSize(0, 0))
        self.scrollAreaWidgetContents_PT.setStyleSheet(u"\u2020")
        self.verticalLayout_10 = QVBoxLayout(self.scrollAreaWidgetContents_PT)
        self.verticalLayout_10.setSpacing(20)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")
        self.verticalLayout_10.setContentsMargins(0, 15, 10, 5)
        self.CollapBox_Flip = CollapsibleBox(self.scrollAreaWidgetContents_PT)
        ...
        self.CollapBox_Flip.setMinimumSize(QSize(0, 255))
        self.CollapBox_Flip.setMaximumSize(QSize(16777215, 255))
        ...
        self.w_Flip_Image.setMinimumSize(QSize(0, 230))
...
"")
        ...
        self.w_x.setMinimumSize(QSize(0, 44))
        ...
        self.w_y.setMinimumSize(QSize(0, 44))
        ...
        self.w_width.setMinimumSize(QSize(0, 44))
        ...
        icon4 = QIcon()
        icon4.addFile(u""+ icons_path +"resize_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_resize.setIcon(icon4)
        ...
        self.w_Tools.setMinimumSize(QSize(0, 140))
        self.w_Tools.setMaximumSize(QSize(180, 140))
        ...
        self.button_reset_rot_flip.setIcon(icon5)
        self.button_reset_rot_flip.setIconSize(QSize(28, 28))
        ...
        icon6 = QIcon()
        icon6.addFile(u""+ icons_path +"rotate_counter.png", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u""+ icons_path +"rotate_counter.png", QSize(), QIcon.Selected, QIcon.On)
        self.button_rot_counter.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u""+ icons_path +"rotate_clock.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_rot_clock.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u""+ icons_path +"mirror_x.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_mirror_y.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u""+ icons_path +"mirror_y.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_mirror_x.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u""+ icons_path +"rotate_v_counter.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_rotv_counter.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u""+ icons_path +"rotate_v_clock.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_rotv_clock.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u""+ icons_path +"mirror_u.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_flip_u.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u""+ icons_path +"mirror_v.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_flip_v.setIcon(icon13)
        ...
        self.w_Im_ex = QWidget(self.w_Flip_Mirror)
        self.w_Im_ex.setObjectName(u"w_Im_ex")
        self.w_Im_ex.setMinimumSize(QSize(120, 140))
        self.w_Im_ex.setMaximumSize(QSize(120, 140))
        self.verticalLayout_13 = QVBoxLayout(self.w_Im_ex)
        ...
        self.label_Im_example.setMinimumSize(QSize(120, 0))
        self.label_Im_example.setMaximumSize(QSize(120, 20))
        ...
        self.verticalLayout_13.addWidget(self.label_Im_example)

        self.w_Im_example = QWidget(self.w_Im_ex)
        self.w_Im_example.setObjectName(u"w_Im_example")
        self.w_Im_example.setMinimumSize(QSize(120, 120))
        self.w_Im_example.setMaximumSize(QSize(120, 120))
        self.w_v = QWidget(self.w_Im_example)
        self.w_v.setObjectName(u"w_v")
        self.w_v.setGeometry(QRect(15, 15, 90, 90))
        sizePolicy4 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy4.setHorizontalStretch(1)
        sizePolicy4.setVerticalStretch(1)
        sizePolicy4.setHeightForWidth(self.w_v.sizePolicy().hasHeightForWidth())
        self.w_v.setSizePolicy(sizePolicy4)
        self.w_v.setMinimumSize(QSize(90, 90))
        self.w_v.setMaximumSize(QSize(90, 90))
        self.gridLayout_3 = QGridLayout(self.w_v)
        self.gridLayout_3.setSpacing(0)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.v32 = QLabel(self.w_v)
        self.v32.setObjectName(u"v32")
        sizePolicy4.setHeightForWidth(self.v32.sizePolicy().hasHeightForWidth())
        self.v32.setSizePolicy(sizePolicy4)
        self.v32.setPixmap(QPixmap(u""+ icons_path +"v32.png"))
        self.v32.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v32, 2, 1, 1, 1)

        self.v31 = QLabel(self.w_v)
        self.v31.setObjectName(u"v31")
        sizePolicy4.setHeightForWidth(self.v31.sizePolicy().hasHeightForWidth())
        self.v31.setSizePolicy(sizePolicy4)
        self.v31.setPixmap(QPixmap(u""+ icons_path +"v31.png"))
        self.v31.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v31, 2, 0, 1, 1)

        self.v23 = QLabel(self.w_v)
        self.v23.setObjectName(u"v23")
        sizePolicy4.setHeightForWidth(self.v23.sizePolicy().hasHeightForWidth())
        self.v23.setSizePolicy(sizePolicy4)
        self.v23.setPixmap(QPixmap(u""+ icons_path +"v23.png"))
        self.v23.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v23, 1, 2, 1, 1)

        self.v11 = QLabel(self.w_v)
        self.v11.setObjectName(u"v11")
        sizePolicy4.setHeightForWidth(self.v11.sizePolicy().hasHeightForWidth())
        self.v11.setSizePolicy(sizePolicy4)
        self.v11.setPixmap(QPixmap(u""+ icons_path +"v11.png"))
        self.v11.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v11, 0, 0, 1, 1)

        self.v12 = QLabel(self.w_v)
        self.v12.setObjectName(u"v12")
        sizePolicy4.setHeightForWidth(self.v12.sizePolicy().hasHeightForWidth())
        self.v12.setSizePolicy(sizePolicy4)
        self.v12.setPixmap(QPixmap(u""+ icons_path +"v12.png"))
        self.v12.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v12, 0, 1, 1, 1)

        self.v21 = QLabel(self.w_v)
        self.v21.setObjectName(u"v21")
        sizePolicy4.setHeightForWidth(self.v21.sizePolicy().hasHeightForWidth())
        self.v21.setSizePolicy(sizePolicy4)
        self.v21.setPixmap(QPixmap(u""+ icons_path +"v21.png"))
        self.v21.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v21, 1, 0, 1, 1)

        self.v22 = QLabel(self.w_v)
        self.v22.setObjectName(u"v22")
        sizePolicy4.setHeightForWidth(self.v22.sizePolicy().hasHeightForWidth())
        self.v22.setSizePolicy(sizePolicy4)
        self.v22.setPixmap(QPixmap(u""+ icons_path +"v22.png"))
        self.v22.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v22, 1, 1, 1, 1)

        self.v33 = QLabel(self.w_v)
        self.v33.setObjectName(u"v33")
        sizePolicy4.setHeightForWidth(self.v33.sizePolicy().hasHeightForWidth())
        self.v33.setSizePolicy(sizePolicy4)
        self.v33.setPixmap(QPixmap(u""+ icons_path +"v33.png"))
        self.v33.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v33, 2, 2, 1, 1)

        self.v13 = QLabel(self.w_v)
        self.v13.setObjectName(u"v13")
        sizePolicy4.setHeightForWidth(self.v13.sizePolicy().hasHeightForWidth())
        self.v13.setSizePolicy(sizePolicy4)
        self.v13.setPixmap(QPixmap(u""+ icons_path +"v13.png"))
        self.v13.setScaledContents(True)

        self.gridLayout_3.addWidget(self.v13, 0, 2, 1, 1)

        self.gridLayout_3.setRowStretch(0, 1)
        self.gridLayout_3.setColumnStretch(0, 1)
        self.aim = QLabel(self.w_Im_example)
        self.aim.setObjectName(u"aim")
        self.aim.setGeometry(QRect(0, 0, 120, 120))
        sizePolicy.setHeightForWidth(self.aim.sizePolicy().hasHeightForWidth())
        self.aim.setSizePolicy(sizePolicy)
        self.aim.setMinimumSize(QSize(120, 120))
        self.aim.setMaximumSize(QSize(120, 120))
        self.aim.setPixmap(QPixmap(u""+ icons_path +"axes.png"))
        self.aim.setScaledContents(True)
        self.gridLayout = QGridLayout(self.w_Im_example)
        ...
        self.bim.setMinimumSize(QSize(120, 120))
        self.bim.setMaximumSize(QSize(120, 120))
        self.bim.setPixmap(QPixmap(u""+ icons_path +"background.png"))
        self.bim.setScaledContents(True)
        self.bim.setIndent(2)

        self.gridLayout.addWidget(self.bim, 0, 0, 1, 1)

        self.bim.raise_()
        self.w_v.raise_()
        self.aim.raise_()

        self.verticalLayout_13.addWidget(self.w_Im_example)


        self.horizontalLayout_4.addWidget(self.w_Im_ex)

        self.w_Im_ex_2 = QWidget(self.w_Flip_Mirror)
        self.w_Im_ex_2.setObjectName(u"w_Im_ex_2")
        self.w_Im_ex_2.setMinimumSize(QSize(120, 140))
        self.w_Im_ex_2.setMaximumSize(QSize(120, 140))
        ...
        self.label_Im_example_2.setMinimumSize(QSize(120, 0))
        self.label_Im_example_2.setMaximumSize(QSize(120, 20))
        ...
        self.w_Im_example_2.setMinimumSize(QSize(120, 120))
        self.w_Im_example_2.setMaximumSize(QSize(120, 120))
        self.w_v_2 = QWidget(self.w_Im_example_2)
        self.w_v_2.setObjectName(u"w_v_2")
        self.w_v_2.setGeometry(QRect(15, 15, 90, 90))
        sizePolicy4.setHeightForWidth(self.w_v_2.sizePolicy().hasHeightForWidth())
        self.w_v_2.setSizePolicy(sizePolicy4)
        self.w_v_2.setMinimumSize(QSize(90, 90))
        self.w_v_2.setMaximumSize(QSize(90, 90))
        self.gridLayout_4 = QGridLayout(self.w_v_2)
        self.gridLayout_4.setSpacing(0)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.v32_2 = QLabel(self.w_v_2)
        self.v32_2.setObjectName(u"v32_2")
        sizePolicy4.setHeightForWidth(self.v32_2.sizePolicy().hasHeightForWidth())
        self.v32_2.setSizePolicy(sizePolicy4)
        self.v32_2.setPixmap(QPixmap(u""+ icons_path +"v32.png"))
        self.v32_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v32_2, 2, 1, 1, 1)

        self.v31_2 = QLabel(self.w_v_2)
        self.v31_2.setObjectName(u"v31_2")
        sizePolicy4.setHeightForWidth(self.v31_2.sizePolicy().hasHeightForWidth())
        self.v31_2.setSizePolicy(sizePolicy4)
        self.v31_2.setPixmap(QPixmap(u""+ icons_path +"v31.png"))
        self.v31_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v31_2, 2, 0, 1, 1)

        self.v23_2 = QLabel(self.w_v_2)
        self.v23_2.setObjectName(u"v23_2")
        sizePolicy4.setHeightForWidth(self.v23_2.sizePolicy().hasHeightForWidth())
        self.v23_2.setSizePolicy(sizePolicy4)
        self.v23_2.setPixmap(QPixmap(u""+ icons_path +"v23.png"))
        self.v23_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v23_2, 1, 2, 1, 1)

        self.v11_2 = QLabel(self.w_v_2)
        self.v11_2.setObjectName(u"v11_2")
        sizePolicy4.setHeightForWidth(self.v11_2.sizePolicy().hasHeightForWidth())
        self.v11_2.setSizePolicy(sizePolicy4)
        self.v11_2.setPixmap(QPixmap(u""+ icons_path +"v11.png"))
        self.v11_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v11_2, 0, 0, 1, 1)

        self.v12_2 = QLabel(self.w_v_2)
        self.v12_2.setObjectName(u"v12_2")
        sizePolicy4.setHeightForWidth(self.v12_2.sizePolicy().hasHeightForWidth())
        self.v12_2.setSizePolicy(sizePolicy4)
        self.v12_2.setPixmap(QPixmap(u""+ icons_path +"v12.png"))
        self.v12_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v12_2, 0, 1, 1, 1)

        self.v21_2 = QLabel(self.w_v_2)
        self.v21_2.setObjectName(u"v21_2")
        sizePolicy4.setHeightForWidth(self.v21_2.sizePolicy().hasHeightForWidth())
        self.v21_2.setSizePolicy(sizePolicy4)
        self.v21_2.setPixmap(QPixmap(u""+ icons_path +"v21.png"))
        self.v21_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v21_2, 1, 0, 1, 1)

        self.v22_2 = QLabel(self.w_v_2)
        self.v22_2.setObjectName(u"v22_2")
        sizePolicy4.setHeightForWidth(self.v22_2.sizePolicy().hasHeightForWidth())
        self.v22_2.setSizePolicy(sizePolicy4)
        self.v22_2.setPixmap(QPixmap(u""+ icons_path +"v22.png"))
        self.v22_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v22_2, 1, 1, 1, 1)

        self.v33_2 = QLabel(self.w_v_2)
        self.v33_2.setObjectName(u"v33_2")
        sizePolicy4.setHeightForWidth(self.v33_2.sizePolicy().hasHeightForWidth())
        self.v33_2.setSizePolicy(sizePolicy4)
        self.v33_2.setPixmap(QPixmap(u""+ icons_path +"v33.png"))
        self.v33_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v33_2, 2, 2, 1, 1)

        self.v13_2 = QLabel(self.w_v_2)
        self.v13_2.setObjectName(u"v13_2")
        sizePolicy4.setHeightForWidth(self.v13_2.sizePolicy().hasHeightForWidth())
        self.v13_2.setSizePolicy(sizePolicy4)
        self.v13_2.setPixmap(QPixmap(u""+ icons_path +"v13.png"))
        self.v13_2.setScaledContents(True)

        self.gridLayout_4.addWidget(self.v13_2, 0, 2, 1, 1)

        self.gridLayout_4.setRowStretch(0, 1)
        self.gridLayout_4.setColumnStretch(0, 1)
        self.aim_2 = QLabel(self.w_Im_example_2)
        self.aim_2.setObjectName(u"aim_2")
        self.aim_2.setGeometry(QRect(0, 0, 120, 120))
        sizePolicy.setHeightForWidth(self.aim_2.sizePolicy().hasHeightForWidth())
        self.aim_2.setSizePolicy(sizePolicy)
        self.aim_2.setMinimumSize(QSize(120, 120))
        self.aim_2.setMaximumSize(QSize(120, 120))
        self.aim_2.setPixmap(QPixmap(u""+ icons_path +"axes.png"))
        self.aim_2.setScaledContents(True)
        self.gridLayout_2 = QGridLayout(self.w_Im_example_2)
        ...
        self.bim_2.setMinimumSize(QSize(120, 120))
        self.bim_2.setMaximumSize(QSize(120, 120))
        self.bim_2.setPixmap(QPixmap(u""+ icons_path +"background.png"))
        self.bim_2.setScaledContents(True)
        self.bim_2.setIndent(2)

        self.gridLayout_2.addWidget(self.bim_2, 0, 0, 1, 1)
        ...
        self.horizontalLayout_4.addWidget(self.w_Im_ex_2)
        ...
        self.w_Resolution = QWidget(self.scrollAreaWidgetContents_PT)
        ...
        self.w_x_Resolution.setMaximumSize(QSize(100, 64))
        ...
        self.w_y_Resolution.setMaximumSize(QSize(100, 64))
        ...
        self.w_dt.setMaximumSize(QSize(100, 64))
        ...
        self.w_Res_eff.setMaximumSize(QSize(120, 60))
        ...
        self.w_OutputSave = QWidget(self.scrollAreaWidgetContents_PT)
...
"padding: 2px;")
        ...
        self.w_combo_saveall = QWidget(self.w_SaveResults)
        self.w_combo_saveall.setObjectName(u"w_combo_saveall")
        self.w_combo_saveall.setMinimumSize(QSize(100, 44))
        self.w_combo_saveall.setMaximumSize(QSize(16777215, 44))
        self.verticalLayout_8 = QVBoxLayout(self.w_combo_saveall)
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.label_saveall = QLabel(self.w_combo_saveall)
        self.label_saveall.setObjectName(u"label_saveall")
        sizePolicy3.setHeightForWidth(self.label_saveall.sizePolicy().hasHeightForWidth())
        self.label_saveall.setSizePolicy(sizePolicy3)
        self.label_saveall.setMinimumSize(QSize(0, 18))
        self.label_saveall.setMaximumSize(QSize(16777215, 18))
        self.label_saveall.setFont(font5)

        self.verticalLayout_8.addWidget(self.label_saveall)

        self.combo_saveall = QComboBox(self.w_combo_saveall)
        self.combo_saveall.addItem("")
        self.combo_saveall.addItem("")
        self.combo_saveall.setObjectName(u"combo_saveall")
        self.combo_saveall.setFont(font)

        self.verticalLayout_8.addWidget(self.combo_saveall)


        self.horizontalLayout_9.addWidget(self.w_combo_saveall)
        ...
        self.w_OutputFold_Button = QWidget(self.scrollAreaWidgetContents_PT)
...
"padding: 2px;")
        ...
        icon14 = QIcon()
        icon14.addFile(u""+ icons_path +"browse_folder_c.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_path.setIcon(icon14)
        ...
        self.w_OutputSubfold = QWidget(self.scrollAreaWidgetContents_PT)
...
"padding: 2px;")
        ...
        self.scrollArea_PT.setWidget(self.scrollAreaWidgetContents_PT)

        self.verticalLayout.addWidget(self.scrollArea_PT)

        QWidget.setTabOrder(self.scrollArea_PT, self.button_back)
        QWidget.setTabOrder(self.button_back, self.button_forward)
        QWidget.setTabOrder(self.button_forward, self.tool_CollapBox_Flip)
        ...
        QWidget.setTabOrder(self.combo_out_type, self.combo_saveall)
        QWidget.setTabOrder(self.combo_saveall, self.check_same_as_input)
    ...
    def retranslateUi(self, ExportTab):
...
#if QT_CONFIG(tooltip)
        self.button_rot_counter.setToolTip(QCoreApplication.translate("ExportTab", u"Rotate the image by 90\u00b0 counterclockwise", None))
#endif // QT_CONFIG(tooltip)
        self.button_rot_counter.setText("")
#if QT_CONFIG(tooltip)
        self.button_rot_clock.setToolTip(QCoreApplication.translate("ExportTab", u"Rotate the image by 90\u00b0 clockwise", None))
#endif // QT_CONFIG(tooltip)
        self.button_rot_clock.setText("")
#if QT_CONFIG(tooltip)
        self.button_mirror_y.setToolTip(QCoreApplication.translate("ExportTab", u"Mirror the image horizontally", None))
#endif // QT_CONFIG(tooltip)
        self.button_mirror_y.setText("")
#if QT_CONFIG(tooltip)
        self.button_mirror_x.setToolTip(QCoreApplication.translate("ExportTab", u"Mirror the image vertically", None))
#endif // QT_CONFIG(tooltip)
        self.button_mirror_x.setText("")
        self.label_Velocity_tool.setText(QCoreApplication.translate("ExportTab", u"Velocity", None))
#if QT_CONFIG(tooltip)
        self.button_rotv_counter.setToolTip(QCoreApplication.translate("ExportTab", u"Rotate the vector field by 90\u00b0 counterclockwise", None))
#endif // QT_CONFIG(tooltip)
        self.button_rotv_counter.setText("")
#if QT_CONFIG(tooltip)
        self.button_rotv_clock.setToolTip(QCoreApplication.translate("ExportTab", u"Rotate the vector field by 90\u00b0 clockwise", None))
#endif // QT_CONFIG(tooltip)
        self.button_rotv_clock.setText("")
#if QT_CONFIG(tooltip)
        self.button_flip_u.setToolTip(QCoreApplication.translate("ExportTab", u"Mirror the vector field horizontally", None))
#endif // QT_CONFIG(tooltip)
        self.button_flip_u.setText("")
#if QT_CONFIG(tooltip)
        self.button_flip_v.setToolTip(QCoreApplication.translate("ExportTab", u"Mirror the vector field vertically", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.aim.setText("")
        self.bim.setText("")
        self.label_Im_example_2.setText(QCoreApplication.translate("ExportTab", u"Transformed", None))
        self.v32_2.setText("")
        self.v31_2.setText("")
        self.v23_2.setText("")
        self.v11_2.setText("")
...
#endif // QT_CONFIG(tooltip)
        self.label_saveall.setText(QCoreApplication.translate("ExportTab", u"Save", None))
        self.combo_saveall.setItemText(0, QCoreApplication.translate("ExportTab", u"all", None))
        self.combo_saveall.setItemText(1, QCoreApplication.translate("ExportTab", u"only mean", None))

#if QT_CONFIG(tooltip)
        self.combo_saveall.setToolTip(QCoreApplication.translate("ExportTab", u"Save all the vector fields or only their ensemble average", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.edit_path_subfold.setToolTip(QCoreApplication.translate("ExportTab", u"Name of the subfolder", None))
#endif // QT_CONFIG(tooltip)
