...
class Ui_InfoPaiRS(object):
    def setupUi(self, InfoPaiRS):
        ...
        InfoPaiRS.resize(650, 450)
        font = QFont()
        font.setFamilies([u"Arial"])
        InfoPaiRS.setFont(font)
        icon = QIcon()
        icon.addFile(u""+ icons_path +"logo_PaIRS.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.tabWidget.setStyleSheet(u"background-color: rgba(255, 255, 255, 0);")
    ...
    def retranslateUi(self, InfoPaiRS):
        ...
        self.logo.setText("")
        self.info.setText(QCoreApplication.translate("InfoPaiRS", u"<html><head/><body><p><span style=\" font-size:18pt; font-weight:700;\">PaIRS - version: #.#.#</span></p><p><span style=\" font-size:16pt; font-weight:700;\">Pa</span><span style=\" font-size:16pt;\">rticle </span><span style=\" font-size:16pt; font-weight:700;\">I</span><span style=\" font-size:16pt;\">mage </span><span style=\" font-size:16pt; font-weight:700;\">R</span><span style=\" font-size:16pt;\">econstruction </span><span style=\" font-size:16pt; font-weight:700;\">S</span><span style=\" font-size:16pt;\">oftware</span></p><p>\u00a9 2022 Gerardo Paolillo &amp; Tommaso Astarita. All rights reserved.</p><p>email: <a href=\"mailto:PaIRS.UniNa@gmail.com\"><span style=\" text-decoration: underline; color:#0000ff;\">PaIRS.UniNa@gmail.com</span></a></p></body></html>", None))
