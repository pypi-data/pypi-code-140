...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 469, 618))
...
"padding: 2px;")
        ...
        icon4 = QIcon()
        icon4.addFile(u""+ icons_path +"browse_folder_c.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_path.setIcon(icon4)
...
"padding: 2px;")
        ...
        icon5 = QIcon()
        icon5.addFile(u""+ icons_path +"browse_file_c.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.button_min = QToolButton(self.w_TR_min)
        self.button_min.setObjectName(u"button_min")
        self.button_min.setMinimumSize(QSize(220, 24))
        self.button_min.setMaximumSize(QSize(220, 24))
        self.button_min.setFont(font)
        self.button_min.setCheckable(True)
        ...
        self.check_subtract_2 = QCheckBox(self.scrollAreaWidgetContents)
        self.check_subtract_2.setObjectName(u"check_subtract_2")
        sizePolicy1.setHeightForWidth(self.check_subtract_2.sizePolicy().hasHeightForWidth())
        self.check_subtract_2.setSizePolicy(sizePolicy1)
        self.check_subtract_2.setMinimumSize(QSize(200, 0))
        self.check_subtract_2.setMaximumSize(QSize(200, 16777215))
        self.check_subtract_2.setFont(font)
        self.check_subtract_2.setLayoutDirection(Qt.RightToLeft)

        self.verticalLayout_8.addWidget(self.check_subtract_2)

        self.w_progress_min = QWidget(self.scrollAreaWidgetContents)
        self.w_progress_min.setObjectName(u"w_progress_min")
        self.w_progress_min.setMinimumSize(QSize(0, 30))
        self.w_progress_min.setMaximumSize(QSize(16777215, 30))
        self.horizontalLayout_4 = QHBoxLayout(self.w_progress_min)
        self.horizontalLayout_4.setSpacing(4)
        self.horizontalLayout_4.setObjectName(u"horizontalLayout_4")
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.hs_w_progress_min = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_4.addItem(self.hs_w_progress_min)

        self.check_subtract = QCheckBox(self.w_progress_min)
        self.check_subtract.setObjectName(u"check_subtract")
        self.check_subtract.setMinimumSize(QSize(80, 0))
        self.check_subtract.setMaximumSize(QSize(80, 16777215))
        self.check_subtract.setFont(font)
        self.check_subtract.setLayoutDirection(Qt.RightToLeft)

        self.horizontalLayout_4.addWidget(self.check_subtract)

        self.separator_min = QFrame(self.w_progress_min)
        self.separator_min.setObjectName(u"separator_min")
        self.separator_min.setFrameShape(QFrame.VLine)
        self.separator_min.setFrameShadow(QFrame.Sunken)

        self.horizontalLayout_4.addWidget(self.separator_min)

        self.progress_min = QProgressBar(self.w_progress_min)
        self.progress_min.setObjectName(u"progress_min")
        self.progress_min.setMinimumSize(QSize(70, 26))
        self.progress_min.setMaximumSize(QSize(70, 26))
        font4 = QFont()
        font4.setKerning(True)
        self.progress_min.setFont(font4)
        self.progress_min.setStyleSheet(u"QProgressBar\n"
"{\n"
"height: 50px\n"
"}")
        self.progress_min.setValue(24)
        self.progress_min.setAlignment(Qt.AlignCenter)
        self.progress_min.setInvertedAppearance(False)

        self.horizontalLayout_4.addWidget(self.progress_min)

        self.label_pause_min = QLabel(self.w_progress_min)
        self.label_pause_min.setObjectName(u"label_pause_min")
        self.label_pause_min.setMinimumSize(QSize(24, 24))
        self.label_pause_min.setMaximumSize(QSize(24, 24))
        self.label_pause_min.setPixmap(QPixmap(u""+ icons_path +"done.png"))
        self.label_pause_min.setScaledContents(True)

        self.horizontalLayout_4.addWidget(self.label_pause_min)

        self.button_pause_min = QToolButton(self.w_progress_min)
        self.button_pause_min.setObjectName(u"button_pause_min")
        self.button_pause_min.setMinimumSize(QSize(24, 24))
        self.button_pause_min.setMaximumSize(QSize(24, 24))
        icon6 = QIcon()
        icon6.addFile(u""+ icons_path +"play.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_pause_min.setIcon(icon6)
        self.button_pause_min.setIconSize(QSize(22, 22))

        self.horizontalLayout_4.addWidget(self.button_pause_min)

        self.button_restart_min = QToolButton(self.w_progress_min)
        self.button_restart_min.setObjectName(u"button_restart_min")
        self.button_restart_min.setMinimumSize(QSize(24, 24))
        self.button_restart_min.setMaximumSize(QSize(24, 24))
        icon7 = QIcon()
        icon7.addFile(u""+ icons_path +"restart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_restart_min.setIcon(icon7)
        self.button_restart_min.setIconSize(QSize(18, 18))

        self.horizontalLayout_4.addWidget(self.button_restart_min)


        self.verticalLayout_8.addWidget(self.w_progress_min)
        ...
        self.verticalSpacer = QSpacerItem(5, 15, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        QWidget.setTabOrder(self.scrollArea, self.button_back)
        QWidget.setTabOrder(self.button_back, self.button_forward)
        QWidget.setTabOrder(self.button_forward, self.edit_path)
        ...
        QWidget.setTabOrder(self.check_TR_sequence, self.button_min)
        QWidget.setTabOrder(self.button_min, self.check_subtract)
        QWidget.setTabOrder(self.check_subtract, self.button_pause_min)
        QWidget.setTabOrder(self.button_pause_min, self.button_restart_min)
        QWidget.setTabOrder(self.button_restart_min, self.spin_x)
...
#endif // QT_CONFIG(tooltip)
        self.label_range_to.setText(QCoreApplication.translate("ImportTab", u"to", None))
#if QT_CONFIG(tooltip)
        self.spin_range_to.setToolTip(QCoreApplication.translate("ImportTab", u"Number of the last image in the sequence to process", None))
#endif // QT_CONFIG(tooltip)
        self.label_list.setText(QCoreApplication.translate("ImportTab", u"Identified image files", None))
...
#if QT_CONFIG(tooltip)
        self.list_images.setToolTip(QCoreApplication.translate("ImportTab", u"List of identified images (select to show)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.button_min.setToolTip(QCoreApplication.translate("ImportTab", u"Calculate and subtract ensemble minimum", None))
#endif // QT_CONFIG(tooltip)
        self.button_min.setText(QCoreApplication.translate("ImportTab", u"Compute minimum", None))
#if QT_CONFIG(tooltip)
        self.check_subtract_2.setToolTip(QCoreApplication.translate("ImportTab", u"Subtract ensemble minimum", None))
#endif // QT_CONFIG(tooltip)
        self.check_subtract_2.setText(QCoreApplication.translate("ImportTab", u"subtract minimum", None))
#if QT_CONFIG(tooltip)
        self.w_progress_min.setToolTip(QCoreApplication.translate("ImportTab", u"Restart computation", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.check_subtract.setToolTip(QCoreApplication.translate("ImportTab", u"Subtract ensemble minimum", None))
#endif // QT_CONFIG(tooltip)
        self.check_subtract.setText(QCoreApplication.translate("ImportTab", u"subtract", None))
        self.label_pause_min.setText("")
#if QT_CONFIG(tooltip)
        self.button_pause_min.setToolTip(QCoreApplication.translate("ImportTab", u"Pause/restart minimum computation", None))
#endif // QT_CONFIG(tooltip)
        self.button_pause_min.setText("")
#if QT_CONFIG(tooltip)
        self.button_restart_min.setToolTip(QCoreApplication.translate("ImportTab", u"Pause/restart minimum computation", None))
#endif // QT_CONFIG(tooltip)
        self.button_restart_min.setText("")
